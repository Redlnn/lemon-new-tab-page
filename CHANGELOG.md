...
- 新增最常访问、自定义快捷访问、自定义搜索引擎图标缓存，在「其他」设置中开启
- 新增新用户欢迎与权限申请提示，启用图标缓存时会引导完成必要的权限设置
...
- 修复开启壁纸视差时边缘出现白边的问题
- 修复 Linux + Chromium 下深色模式启动时闪白屏的问题

## 3.2.0 (2026-03-15)

### 新特性✨

- 新增底部 Dock 栏及 Launchpad
- 新增「不活动时渐隐页面元素」
- 全面支持键盘导航（`Tab` + 方向键）
- 支持为搜索栏和快捷方式添加边框以提升观感
- 【背景】支持保存当前显示的壁纸
- 【背景】支持开启视差效果
- 【一言】新增一键复制
- 【时钟】新增新式时钟风格，支持更多字体大小及日期字体粗细
- 【时钟】新增多彩时钟开关
- 【搜索栏】按 `Tab` 时提示当前搜索引擎名称
...
- 微调部分元素样式及翻译
- 功能未启用时隐藏相关设置项
- 支持在多个打开的新标签页之间实时同步设置更改
- 优化深色模式的切换体验
- 【一言】新增点击动画
- 【搜索】因大部分设备均会卡顿，默认禁用启动时搜索框展开动画
- 【时钟】字体大小改为滑块调整，最大支持 200px
- 【壁纸栏】在开启缓存的情况下，若无法获取新壁纸，即使缓存过期也仍使用缓存
- 【云同步】不再同步莫奈配色、壁纸缓存和自定义搜索引擎
- 【背景】遮罩只提供开关,不透明度改为使用色值控制，以区分日夜模式透明度

### 修复🐛

- 修复首次打开设置面板时弹出动画卡顿的问题
- 【搜索】修复聚焦搜索栏时点击一言会丢失焦点的问题
- 【一言】修复开启总是显示后在某些情况下没有显示的问题
...
祝你新春快乐！在这个充满希望的日子里，愿你的每一天都像柠檬一样清新美好！感谢大家一直以来的支持和反馈，期待在新的一年里继续陪伴着你！

### 新特性✨

- 【快捷访问】增加“标题扩展宽度”、“图标与标题间距”设置项
  ([#65](https://github.com/Redlnn/lemon-new-tab/issues/65))
- 【书签栏】可以通过右键菜单将快捷方式收藏至浏览器书签
- 【书签栏】支持编辑与删除
- 【书签栏】支持拖动重新排序
- 【书签栏】支持折叠其他/所有同级目录
- 【书签栏】支持设置默认排序方式
...
- 【时钟】支持设置字体粗细
- 【时钟】支持设置 AM/PM 字体大小跟随时间字体大小
- 【时钟】支持设置字体大小，可选择小、中、大
- 【搜索栏】支持按 ESC 关闭
- 【在线壁纸】在线壁纸现在支持缓存与刷新了
...
- 优化性能和细节
- 优化移动端页面布局，修复错位、抖动、元素重叠等问题
- 切换到必应壁纸时强制刷新一次
- 莫奈取色更新到2025年最新实现规范
- 【快捷访问】优化翻页逻辑
- 【快捷访问】优化触摸时快速访问滑动翻页与拖动排序的触发优先级
  > 现在翻页更不容易触发拖动排序了
- 【快捷访问】重构快捷方式布局算法以优化性能及移动端适配
- 【快捷访问】调整快捷方式右键菜单的选项顺序、图标、图标粗细
- 【书签栏】只有在非原始排序时才把文件夹排在最前
- 【书签栏】默认排序更改为原始排序
- 【书签栏】允许展开多个同级目录
- 【书签栏】默认展开第一个有内容的顶层目录
- 【时钟】英语环境下的 AM/PM 放置位置调整为时间前方

### Breaking Change💥

- 移除了对旧版本配置的兼容，若遇到不支持的配置数据，将提示重置设置并清除数据
- 【快捷访问】由于失去维护且与翻页样式冲突，移除“显示区域背景”
...
- 修复设置迁移逻辑没有生效的问题
- 修复开启云同步会覆盖云端配置的问题
- 尝试修复移动端通过返回操作回到新标签页时丢失背景的问题
- 【搜索栏】修复搜索框键入后在显示联想前失去焦点仍会显示联想的bug
- 【书签栏】修复在别处更改书签后已打开的新标签页内不会同步更新的问题
- 【快捷访问】修复缩小窗口宽度时部分快捷方式标题会被挡住的问题
- 【快捷访问】修复能看到前后页快捷方式部分标题的问题
- 【快捷访问】修复火狐快捷访问翻页时闪烁
  ([#64](https://github.com/Redlnn/lemon-new-tab/issues/64))
- 【背景】修复深色模式下刚打开时闪烁白色背景的问题
- 【设置】修复开启跟随系统时，深色模式按钮不跟随系统变化的问题

## 3.0.1 (2026-01-02)

### 修复🐛

- 修复火狐上快捷访问图标背景模糊失效的问题
  ([#64](https://github.com/Redlnn/lemon-new-tab/issues/64))
...
- 修复开启全局色彩时部分按钮背景色不正确
- 修复简体中文中在线背景提示的错别字
  ([#49](https://github.com/Redlnn/lemon-new-tab/pull/49) by [@Sam Hou](https://github.com/SamHou0))
