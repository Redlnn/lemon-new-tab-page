...
- 修复开启全局色彩时部分按钮背景色不正确
- 修复简体中文中在线背景提示的错别字 ([#49](https://github.com/Redlnn/lemon-new-tab-page/49) by [@Sam Hou](https://github.com/SamHou0))
...
- 修复切换颜色时没有过渡的问题
- 修复深色模式下仅上传浅色模式壁纸且壁纸为图片时不显示壁纸 (#40)
- 修复样式缺失
- 修复深色模式按钮状态不跟随浏览器或系统切换 (#42)
- 修复设置页部分元素缺少颜色过度动画 (#43)
- 修复本地化错误/缺失
